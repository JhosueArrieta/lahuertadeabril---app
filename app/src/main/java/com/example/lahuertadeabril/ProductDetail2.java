...
public class ProductDetail2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("MERCADONA");
        }

        // Obtener el ID del álbum desde los extras
        String product2Id = getIntent().getStringExtra("PRODUCT2_ID");

        if (product2Id == null) {
            // Manejar el caso en que albumId sea nulo
            Toast.makeText(this, "Error: product2Id es nulo", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            if (item.getItemId() == R.id.navigation_favourites) {
                startActivity(new Intent(ProductDetail2.this, FavouritesScreen.class));
                return true;
            }
            ...
            if (item.getItemId() == R.id.navigation_options) {
                startActivity(new Intent(ProductDetail2.this, AccountScreen.class));
                return true;
            }
            return false;
        });
        ...
        int intProduct2Id = Integer.parseInt(product2Id);
        Call<Product2Response> call = apiService.getProduct2Info(intProduct2Id);

        call.enqueue(new Callback<Product2Response>() {
            @Override
            public void onResponse(Call<Product2Response> call, Response<Product2Response> response) {
                if (response.isSuccessful() && response.body() != null){
                    Product2Response product2 = response.body();

                    // Log para el éxito de la respuesta y datos obtenidos
                    Log.d("AlbumInfoScreen", "Response received: " + product2.toString());
                    Log.d("AlbumInfoScreen", "Image URL: " + product2.getImage());

                    nameProduct.setText(product2.getName());
                    originProduct.setText(product2.getOriginProduct());
                    priceProduct.setText(String.valueOf(product2.getPriceProduct()));
                    // Cargar la imagen utilizando Picasso
                    Picasso.get().load(product2.getImage()).into(imageView);
                }else {
            ...
            @Override
            public void onFailure(Call<Product2Response> call, Throwable t) {
    ...
    private void addToFavorites() {
        ...
        String apiUrl = "http://10.0.2.2:8000/v1/add_favourites_2/" + product2Id + "/";
        ...
        JsonObjectRequestWithAuthentication request = new JsonObjectRequestWithAuthentication(
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Toast.makeText(ProductDetail2.this, "Añadido a favoritos exitosamente", Toast.LENGTH_SHORT).show();
                    }
                },
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ProductDetail2.this, "Error al añadir a favoritos", Toast.LENGTH_SHORT).show();
                    }
                },
